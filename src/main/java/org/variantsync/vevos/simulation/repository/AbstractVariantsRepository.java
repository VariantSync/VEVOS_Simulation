...
/**
 * Repository that mimics the evolution of an ISPLRepository in terms of
 * variants instead of an integrated code base.
 */
public abstract class AbstractVariantsRepository extends Repository<VariantCommit> {
     ...
     * @return A handle for the commit that was just created. Returns empty if there
    ...
    /**
     * @return The first revision of variants of this repository. Empty, iff there
