 ...
 * Apart from giving access to the visited element (@see getValue()), the focus
 * can and should be instructed
...
public abstract class ArtefactVisitorFocus<A extends Artefact> {
     ...
     * This will invoke the corresponding visit-method in the visitor depending on
     * the type of data <A> in focus.
     * 
