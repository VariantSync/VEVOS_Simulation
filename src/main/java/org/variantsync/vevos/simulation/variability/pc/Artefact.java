...
public interface Artefact {
    /**
     * @return the feature mapping of this node (i.e., the feature formula
     ...
     *         (i.e., the conjunction of feature mapping with the parents presence
     *         condition).
     */
    Node getPresenceCondition();

    /**
     * @return File on disk this artefact is associated to. This artefact can
     *         represent the entire file or a part of
     *         that file.
     */
    ...
    @Deprecated
    /**
     * Simplifies the artefact w.r.t. to presence conditions and redundant
     * structure.
     ...
     * This object will not be altered, meaning a copy that represents the derived
     * variant is returned.
     * 
     * @param variant   The variant for which the feature traces should be reduced.
     * @param sourceDir The directory of the product line from which variants should
     *                  be build.
     ...
     */
    Result<GroundTruth, Exception> generateVariant(Variant variant, CaseSensitivePath sourceDir,
            CaseSensitivePath targetDir, VariantGenerationOptions strategy);
     ...
     * This method is not supposed to be invoked by users but the visitor
     * infrastructure only.
