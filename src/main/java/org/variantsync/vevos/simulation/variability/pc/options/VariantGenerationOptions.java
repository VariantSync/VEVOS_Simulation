...
public record VariantGenerationOptions(
    ...
    public static VariantGenerationOptions ExitOnError(final boolean withMacros,
            final ArtefactFilter<SourceCodeFile> filter) {
        return new VariantGenerationOptions(true, false, withMacros, filter);
    }

    public static VariantGenerationOptions ExitOnErrorButAllowNonExistentFiles(final boolean withMacros,
            final ArtefactFilter<SourceCodeFile> filter) {
