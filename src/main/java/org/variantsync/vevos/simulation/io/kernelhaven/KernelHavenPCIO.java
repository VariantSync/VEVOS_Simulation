...
/**
 * Abstract class to load presence conditions from the csv file generated by
 * KernelHaven.
 */
        ...
        try {
            ...
            for (final String[] row : rows) {
                ...
                if (presenceConditionNode == null) {
                    Logger.warn(
                            "Was not able to parse the presence condition for " + pathOfSourceFile + " in " + csvPath);
                ...
                // We don't need the actual presenceCondition (lol) as it is a value computed
