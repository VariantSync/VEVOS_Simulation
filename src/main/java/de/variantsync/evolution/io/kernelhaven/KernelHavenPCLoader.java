 ...
 */
public class KernelHavenPCLoader implements ResourceLoader<FeatureTrace> {
    @Override
    ...
    @Override
    public Result<FeatureTrace, Exception> load(Path csvPath) {
        ...
        return Result.Success(new FeatureTraceTree<>(allFiles));
    }
}
